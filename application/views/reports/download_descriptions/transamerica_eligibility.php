    ...
    <div class="m-b-10">
        ...
        <div class="download-help hidden">
            <p class="form-description modal-ignored-text">
                Import file for Transamerica Eligibility/Claims system.  This file requires the following optional fields to generate:  Group Number, Enrollment State, Relationship, Address1, City, State/Province, Postal Code
