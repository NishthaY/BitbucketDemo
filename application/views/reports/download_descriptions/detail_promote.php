...
<div class="download-report-row-container grayBorder-b">
    <div class="m-b-10">
        <div class="download-row">
            ...
            <a class="btn-sm btn-working pull-right" href="JavaScript:Void(0);">Download</a>

            <div class="clearfix"></div>
        </div>
        <div class="download-help hidden">
            <p class="form-description modal-ignored-text">
                Individual billing records for carrier including retroactivity.  This data file is a complete backup to our carrier summary report structured as one record per person per product.  If any adjustments are calculated on a person/product level, a complete explanation of the adjustment is noted on that record.
            </p>
        </div>
    </div>
</div>
