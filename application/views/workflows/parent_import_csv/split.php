...
else if ( ! $running && ! $completed )
{
    // Pending
    ?>
    <a href="#" class="ladda-button a2p-forever-spinner-button pull-right btn w-lg btn-working btn-lg m-r-5" disabled  data-style="expand-left">Splitting Import</a>
    <?php
...
}else
{
    // Finished
    ?>
    <!-- <a href="#" class="ladda-button a2p-forever-spinner-button pull-right btn w-lg btn-working btn-lg" disabled  data-style="expand-left">Finished Split</a> -->
    <?php
}
