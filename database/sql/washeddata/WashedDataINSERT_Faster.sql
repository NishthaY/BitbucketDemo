...
from
  ...
  join "CompanyLife" on ( "CompanyLife"."Id" = "LifeData"."LifeId" AND "CompanyLife"."Enabled" = true ) -- BAH, the life must be enabled.
  ...
  left join "WashedData" on ( "WashedData"."ImportDataId" = "ImportData"."Id" )
where
