insert into "ReportTransamericaEligibility" ("CompanyId", "ImportDate", "ImportDataId", "LifeId", "CarrierId", "PlanTypeId", "PlanId", "CoverageTierId", "EmployeeNumber", "ProductType", "Option", "Tier", "LostItem", "RelationshipSSN", "RelationshipEID")
select
  ...
  , true as "LostItem"
  , coalesce ( last_month."EmployeeSSN", last_month."EmployeeId" ) as "RelationshipSSN"  -- Assumes EmployeeSSN is the field that will hold the relationship between employee and dependents
  , coalesce ( last_month."EmployeeId", last_month."EmployeeSSN" ) as "RelationshipEID"  -- Assumes EmployeeId is the field that will hold the relationship between employee and dependents
from
  ...
  left join "ReportTransamericaEligibility" this_month on
                                             (
