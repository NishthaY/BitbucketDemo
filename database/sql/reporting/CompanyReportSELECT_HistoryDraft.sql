select display_date, import_date, carrier, carrier_id, report_type_id, summary_report_id, detail_report_id, draft_flg, company_id, report_name, report_code from
	(
		...
		select
				TO_CHAR(r1."ImportDate", 'Month YYYY') as display
			, r1."ImportDate" as import_date
...
order by import_date desc, carrier asc
