...
INSERT INTO "AppOption" ( "Key", "Value") VALUES ( 'ONE_OFF_DYNO_SUPPORT_ENABLED', 'TRUE' ) ON CONFLICT ("Key") DO UPDATE SET "Value" = 'TRUE';
INSERT INTO "AppOption" ( "Key", "Value") VALUES ( 'ONE_OFF_DYNO_SIZE', 'Shield-M' ) ON CONFLICT ("Key") DO UPDATE SET "Value" = 'Shield-M';
INSERT INTO "AppOption" ( "Key", "Value") VALUES ( 'ONE_OFF_DYNO_PHP_MEMORY_LIMIT', '2000M' ) ON CONFLICT ("Key") DO UPDATE SET "Value" = '2000M';
